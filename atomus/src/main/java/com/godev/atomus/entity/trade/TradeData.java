...
public record TradeData(Long id, Long userId, EnumTradeType enumTradeType, LocalDate tradeDate, Long brokerId, Long productId, String title, Integer quantity, Double unitPrice, Double fees) {
